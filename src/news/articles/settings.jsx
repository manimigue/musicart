...
`
.replace('assets/スクリーンショット 2019-04-13 22.55.51.png',I0)
.replace('assets/スクリーンショット 2019-04-13 23.10.07.png',I1)
.replace('assets/スクリーンショット 2019-04-13 23.14.33.png',I2)
.replace('assets/スクリーンショット 2019-04-14 21.45.37.png',I3)
.replace('assets/スクリーンショット 2019-04-14 22.39.24.png',I4)
    return(
