  ...
  render() {
    return (
      <div className='tickets-info'>
        <h4>チケット情報</h4>
        <h5>チケット種類</h5>
        <p><b>先行予約チケット(自由席・一部指定席)</b><br/> 大人 1,000 円<br/>学生(高校生以上、要学生証)1,000 円 <br/>小人(中学生以下)無料<br/></p>
        <p><b>当日チケット(自由席・一部指定席)</b> <br/>大人 1,500 円 <br/>学生(高校生以上、要学生証)1,000 円 <br/>小人(中学生以下)無料</p>
